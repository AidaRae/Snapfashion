...
@section('admin')
    ...
    <div class="p-4 sm:p-6 lg:p-8 pb-20 lg:pb-8">
        ...
        <div class="flex items-center gap-2 text-xs text-gray-400 dark:text-gray-500 mb-5">
            ...
            <span class="text-gray-600 dark:text-gray-300 font-medium">Add Manual Order</span>
        </div>

        <div class="s-card max-w-4xl mx-auto">
            <div class="p-5 sm:p-8 border-b border-gray-100 dark:border-neutral-800">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Create New Order manually</h2>
                <p class="text-sm text-gray-500 mt-1">Fill out the details below to manually place an order for a customer.
                </p>
            </div>

            <form action="{{ route('admin.order.store') ?? '#' }}" method="POST" class="p-5 sm:p-8 space-y-8">
                @csrf

                {{-- Customer Selection --}}
                <div>
                    <h3
                        class="text-lg font-bold text-gray-800 dark:text-gray-200 mb-4 border-b border-gray-100 dark:border-neutral-800 pb-2">
                        Customer Details</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="shipping_address" class="form-input" rows="2" placeholder="Full address..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="product_search" class="form-input" placeholder="Select products...">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="payment_method" class="form-input">
                                ...
                                <option value="Manual Bank Transfer">Bank Transfer</option>
                            </select>
                        </div>
                        <div>
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 dark:border-neutral-800 flex items-center justify-end gap-3">
                    <a href="{{ route('admin.orders') ?? '#' }}" class="btn-outline-custom">Cancel</a>
                    <button type="submit" class="btn-primary-custom">Create Order</button>
                </div>
            </form>
        </div>
    </div>
